...
const simpleElement: string = """<p>
    Hello world!
</p>"""
const simpleElementWithClass: string = """<p class='center'>
    Hello world!
</p>"""
...
const customAttrElementWithChildren: string = """<optgroup label='Cool Cats'>
    <option selected value='cat_lucy'>
        Lucy
    </option>
    <option value='cat_findus'>
        Findus
    </option>
    <option value='cat_nyan_cat'>
        Nyan-Cat
    </option>
</optgroup>"""
